...
func (solver ProblemSolver) SolveQuant(quant mentalese.Relation, nameStore *ResolvedNameStore, binding mentalese.Binding) []mentalese.Binding {
	...
	// todo: dit werkt alleen voor EVERY
...
//func (solver ProblemSolver) SolveQuant1(quant mentalese.Relation, nameStore *ResolvedNameStore, binding mentalese.Binding) []mentalese.Binding {
//
