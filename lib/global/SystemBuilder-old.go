...
type systemBuilderOld struct {
	log     *common.SystemLog
	baseDir string
	parser  *importer.InternalGrammarParser
}

func NewsystemBuilderOld(baseDir string, log *common.SystemLog) systemBuilderOld {

	parser := importer.NewInternalGrammarParser()
	parser.SetPanicOnParseFail(false)

	return systemBuilderOld{
		baseDir: baseDir,
		parser:  parser,
		log:     log,
	}
...
func (builder systemBuilderOld) BuildFromConfig(system *system, config systemConfig) {
...
func (builder systemBuilderOld) CreateTokenizer(configExpression string) *parse.Tokenizer {
...
func (builder systemBuilderOld) CreatePredicates(path string) (mentalese.Predicates, bool) {
...
func (builder systemBuilderOld) ImportGrammarFromPath(system *system, grammarPath string) {
...
func (builder systemBuilderOld) ImportGenerationGrammarFromPath(system *system, grammarPath string) {
...
func (builder systemBuilderOld) ImportRuleBaseFromPath(solver *central.ProblemSolver, ruleBasePath string) {
...
func (builder systemBuilderOld) ImportInMemoryFactBase(name string, solver *central.ProblemSolver, factBase relationSetFactBase, matcher *mentalese.RelationMatcher) {
...
func (builder systemBuilderOld) LoadSharedIds(path string) (knowledge.SharedIds, bool) {
...
func (builder systemBuilderOld) ImportMySqlDatabase(name string, solver *central.ProblemSolver, nameResolver *central.NameResolver, factBase mysqlFactBase, matcher *mentalese.RelationMatcher) {
...
func (builder systemBuilderOld) ImportSparqlDatabase(name string, solver *central.ProblemSolver, predicates mentalese.Predicates, factBase sparqlFactBase, matcher *mentalese.RelationMatcher) {
...
func (builder systemBuilderOld) CreateConfigMap(path string) (mentalese.ConfigMap, bool) {
...
func (builder systemBuilderOld) CreateEntities(path string) (mentalese.Entities, bool) {
...
func (builder systemBuilderOld) ImportSolutionBaseFromPath(system *system, solutionBasePath string) {
