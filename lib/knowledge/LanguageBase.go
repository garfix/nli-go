...
func (base *LanguageBase) createAnswer(messenger api.ProcessMessenger, intent mentalese.Intent, resultBindings mentalese.BindingSet, responseIndex int) (mentalese.RelationSet, mentalese.BindingSet) {
