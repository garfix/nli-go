...
func (e *Ellipsizer) Ellipsize(tree ParseTreeNode) ParseTreeNode {
...
func (e *Ellipsizer) hasEllipsis(node ParseTreeNode) bool {
...
func (e *Ellipsizer) ellipsizeNode(node *BidirectionalParseTreeNode) *ParseTreeNode {
	newSource := node.source

	// add original constituents, having been ellipsized
	newConstituents := []*ParseTreeNode{}
...
func (e *Ellipsizer) createEllipsisConstituents(node *BidirectionalParseTreeNode) []*ParseTreeNode {
	ellipsisConstituents := []*ParseTreeNode{}
