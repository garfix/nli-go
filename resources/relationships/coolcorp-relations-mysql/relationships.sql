...
insert into parent values (1, 7);
insert into parent values (1, 8);
...
insert into person values (7, 'Johanneke de Boer', 'M', '1998');
insert into person values (8, 'Baukje de Boer', 'F', '1999');
insert into person values (9, 'Henk Smit', 'M', '1963');
